...
export const STRINGS = {
  ...
  help: {
    ...
    parts4: "The names come from the tab, so they are whatever the person who wrote it out called them — \"Intro/Verse\", \"Guitar Solo\", \"Estribillo\". Two parts with the same name are numbered, so nothing in your DAW is called the same thing twice.",
